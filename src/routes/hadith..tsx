...
export const Route = createFileRoute("/hadith/")({
  head: ({ params }) => {
    ...
    const description = `Browse all books within the ${label} collection. Each book contains authenticated hadiths with Arabic text and English translation.`;
    const canonical = `/hadith/${params.collection}`;
