...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your learning journey, bookmarks, notes and recommended topics." },
      { property: "og:title", content: "Noor Al Quran | My Profile" },
      { property: "og:description", content: "Your learning journey, bookmarks, notes and recommended topics." },
      { property: "og:url", content: "/profile" },
      { name: "twitter:title", content: "Noor Al Quran | My Profile" },
      { name: "twitter:description", content: "Your learning journey, bookmarks, notes and recommended topics." },
    ],
