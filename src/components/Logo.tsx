...
export function Logo({ className = "h-10 w-10" }: { className?: string }) {
  return (
    ...
    >
      ...
      <rect
        x="3.5" y="3.5" width="57" height="57" rx="12.5"
        fill="none" stroke="url(#logo-gold)" strokeWidth="0.8" opacity="0.55"
      />
      ...
      <g transform="translate(32 32)" fill="none" stroke="url(#logo-gold)" strokeLinejoin="round">
        ...
        <rect
          x="-18" y="-18" width="36" height="36" rx="1.5"
          strokeWidth="1.4" transform="rotate(45)"
        />
        {/* Inner medallion */}
        ...
        <g fill="url(#logo-gold)" stroke="none">
          ...
          <path
            d="M 7.5 -1 l 1.1 2.3 l 2.5 .35 l -1.8 1.75 l .45 2.5 l -2.25 -1.2 l -2.25 1.2 l .45 -2.5 l -1.8 -1.75 l 2.5 -.35 z"
          />
        </g>
      </g>
    </svg>
